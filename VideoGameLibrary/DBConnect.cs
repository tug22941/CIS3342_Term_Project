...
namespace VideoGameLibrary
{
    public class DBConnect
    {
        ...
        //string SqlConnectString = ConfigurationManager.ConnectionStrings["cnRestaurantReviews"].ConnectionString;


        // Home Connection String - used for working from home using SSH Tunneling.
        //Back up connection string:
        //String SqlConnectString = "server=127.0.0.1,5555;Database=fa20_3342_tuk84625;User id=tuk84625;Password=sieD9thoom";
