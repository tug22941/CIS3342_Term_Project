                        ...
                        <ItemTemplate>                             
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <asp:TextBox ID="txtQuantity" Width="70" AutoPostBack="true" runat="server" Text='<%#Eval("Quantity") %>' TextMode="Number" OnTextChanged="txtQuantity_TextChanged"/>
                                    <asp:rangevalidator CssClass="displayBlock" ID="rval1" errormessage="Please enter value > 0" forecolor="Red" ControlToValidate="txtQuantity" MinimumValue="1"  MaximumValue="100" runat="server" Type="Integer">
                                    </asp:rangevalidator>
                                </div>
                                <div class="col">
                                    <b>Price: </b>
