...
namespace VideoGameStoreWeb
{
    public partial class Checkout : System.Web.UI.Page
    {
        ...
        protected void txtQuantity_TextChanged(object sender, EventArgs e)
        {
            ...
            if(quantity < 1)
            {
                //reset textbox to minimum allowed quantity and show warning
                tb.Text = "1";
                ShowMessage("Minimum quantity per item is 1. To delete an item, click the delete button.", "warning");
            }
            else
            {
                Cart cart = (Cart)Application["Cart"];
